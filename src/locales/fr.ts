...
export const fr = {
  ...
  home: {
    ...
    pedago: {
      ...
      stat1Num: "800+",
      stat1Title: "Questions validées",
      stat1Desc:
        "Alignées sur les programmes FR et international, vérifiées pédagogiquement",
      stat2Num: "9",
    ...
    pricingTeaser: {
      ...
      premiumBadge: "Le plus populaire",
      premiumLabel: "Erudia+",
      premiumPrice: "4,99€",
      premiumPeriod: "/ mois · ou 39,99€/an",
      premiumF1: "Toutes les catégories (9)",
      ...
      premiumCta: "Essayer 7 jours gratuits",
  ...
  features: {
    ...
    comparison: {
      ...
      col0:    'Fonctionnalité',
      rows: [
        { feature: 'Mode offline / PWA',        kahoot: '❌',            quizizz: '❌',              splash: '❌',               erudia: '✅' },
        { feature: 'Bilingue FR/EN',             kahoot: '✅ (18 langues)', quizizz: '✅ (multi)',      splash: '❌ (EN only)',      erudia: '✅ (FR/EN)' },
        { feature: 'Quiz multi-catégories',      kahoot: '✅',            quizizz: '✅',              splash: '❌ (maths/lecture)', erudia: '✅' },
        { feature: 'Mode parent intégré',        kahoot: '❌ (séparé)',   quizizz: '❌ (orienté classe)', splash: '✅ (dashboard)',  erudia: '✅ (in-app)' },
        { feature: 'Badges & gamification',      kahoot: '✅',            quizizz: '✅',              splash: '⚠️ (basique)',       erudia: '✅ (14 badges)' },
        { feature: 'Défi quotidien',             kahoot: '⚠️',           quizizz: '⚠️',              splash: '❌',               erudia: '✅' },
        { feature: 'Mode duel asynchrone',       kahoot: '❌',            quizizz: '❌',              splash: '❌',               erudia: '✅' },
        { feature: 'Rapports PDF parents',       kahoot: '⚠️ (payant)',  quizizz: '❌',              splash: '✅',               erudia: '✅' },
        { feature: 'Pricing transparent',        kahoot: '❌',            quizizz: '⚠️',              splash: '❌',               erudia: '✅' },
        { feature: 'COPPA / RGPD',              kahoot: '✅',            quizizz: '✅',              splash: '✅',               erudia: '✅' },
        { feature: 'Sans publicité',             kahoot: '❌ (free)',     quizizz: '❌',              splash: '❌',               erudia: '✅' },
      ],
    },
    content: {
      pill:        '📚 Le contenu',
      ...
      noteText:    'c\'est une invitation à progresser. Erudia challenge pour faire grandir, pas pour décourager.',
      tableLevel:  'Niveau',
      tableFr:     'Programme FR',
      tableEn:     'Programme EN',
      tableDiff:   'Difficulté',
      curriculum: [
        { level: 'Facile',   fr: 'CP → CE2',  en: 'Grade 1 → Grade 3', chip: 'easy' },
        { level: 'Moyen',    fr: 'CM1 → CM2', en: 'Grade 4 → Grade 5', chip: 'medium' },
        { level: 'Difficile', fr: '6e → 4e',  en: 'Grade 6 → Grade 8', chip: 'hard' },
      ],
      catPill: 'Catégories de quiz',
      categories: [
        { icon: '🔬', name: 'Sciences',          sub: '300 questions FR + EN',     color: '#2196F3', premium: false },
        { icon: '📜', name: 'Histoire',           sub: '500 questions FR + EN',     color: '#795548', premium: false },
        { icon: '⚔️', name: 'Héros & Aventures', sub: '75 questions (en croissance)', color: '#E91E63', premium: false },
        { icon: '🌍', name: 'Géographie',         sub: 'À venir',                   color: '#00BCD4', premium: true },
        { icon: '🚀', name: 'Espace & Astronomie', sub: 'À venir',                  color: '#9C27B0', premium: true },
        { icon: '🏛️', name: 'Mythologie',         sub: 'À venir',                   color: '#FF5722', premium: true },
        { icon: '➕', name: 'Mathématiques',       sub: 'À venir',                   color: '#4CAF50', premium: true },
        { icon: '🗳️', name: 'Éducation Civique',  sub: 'À venir',                   color: '#607D8B', premium: true },
        { icon: '🍳', name: 'Cuisine',             sub: 'À venir',                   color: '#FF9800', premium: true },
      ],
      badgeFree:    'Gratuit',
    ...
    parent: {
      ...
      subline: "Le mode admin est intégré directement dans l'app enfant — protégé par authentification, accessible en 2 clics.",
      items: [
        {
          icon:  '🛡️',
        ...
        },
        {
          ...
          list:  ['BarChart scores par catégorie', 'PieChart répartition des sessions', 'Évolution sur 7 / 30 jours'],
        },
        {
          icon:  '🎯',
        ...
        },
        {
          ...
          list:  ['Planification hebdo / mensuelle', 'Envoi manuel en un clic', 'PDF avec graphiques inclus'],
        },
        {
          icon:  '🔄',
    ...
    nova: {
      ...
      poses: [
        { label: 'Joyeuse',       emotion: 'Réponse correcte',  src: '/mascotte-correct.svg' },
        { label: 'Concentrée',    emotion: 'Pendant le quiz',    src: '/mascotte-idle.svg' },
        { label: 'En fête',       emotion: 'Badge débloqué !',   src: '/mascotte-streak.svg' },
        { label: 'Encourageante', emotion: 'Après une erreur',   src: '/mascotte-encouragement.svg' },
      ],
    },
    convictions: {
      ...
      items: [
        {
          ...
          insightText:   "sur iOS, Android et desktop. Pas besoin de télécharger depuis un store. Une icône sur l'écran d'accueil, comme une vraie app.",
        },
        {
          number:  '02',
          badge:   'Pédagogie',
          ...
          insightText:   "Sciences, Histoire, Héros & Aventures disponibles dès maintenant. Maths, Géographie, Astronomie, Mythologie et Éducation Civique en préparation.",
        },
        {
          number:  '03',
          badge:   'Langue',
          ...
          insightText:   "accessible dès l'onboarding et depuis le profil. Pas de double compte, pas de réinstallation. L'immersion linguistique commence naturellement.",
        },
        {
          number:  '04',
          badge:   'Éthique',
          ...
          insightText:   "aucune donnée enfant revendue, aucun tracker tiers. La version gratuite est sans pub — pas un modèle freemium déguisé.",
        },
        {
          number:  '05',
          badge:   'Famille',
          ...
          insightText:   "l'enfant ne peut pas accéder au mode admin. Rapports PDF envoyés automatiquement par email, chaque semaine ou chaque mois.",
        },
        {
          number:  '06',
          badge:   'Confiance',
          ...
          insightText:   "pas de paywall caché après 3 questions, pas d'upsell agressif. Ce qui est gratuit est vraiment gratuit.",
        },
      ],
    },
    child: {
  ...
  pricing: {
    ...
    cards: {
      ...
      freePeriod: "Pour toujours",
      freeCta: "Commencer gratuitement",
      freeReassure: "Pas de carte de crédit requise",
      ...
      freeF5: "Mode duel asynchrone",
      freeF6: "Mode hors ligne (PWA)",
      freeF7: "Bilingue FR / EN",
      freeF8: "1 profil enfant",
      freeF9: "Historique cloud : 10 dernières sessions",
      freeF10: "Contrôles parentaux basiques",
      ...
      premiumPriceA: "3,33€",
      premiumPeriodM: "/ mois",
      premiumPeriodA: "/ mois (facturé annuellement)",
      premiumSavings: "→ soit 39,99€/an — économisez 19,89€",
      premiumSavingsAmount: "19,89€ économisés",
      premiumCta: "Essayer 7 jours gratuits",
      premiumReassure: "Pas de CB · Annulation à tout moment",
      premiumFeaturesTitle: "Tout du plan gratuit, plus :",
      premiumF1: "Toutes les catégories — 9 au total",
    ...
    faqBilling: {
      ...
      a6: "Oui — 7 jours d'essai gratuits sur Erudia+, sans carte de crédit requise. À la fin de l'essai, vous choisissez de continuer ou non. Aucun prélèvement automatique sans votre accord explicite.",
    },
    guarantee: {
      ...
      g2Title: "Remboursement 14 jours",
      g2Desc:
        "Pas satisfait dans les 14 jours ? Remboursement intégral, sans question, sans formulaire compliqué. Un email suffit.",
    ...
    cta: {
      ...
      sub: "Commencez gratuitement dès aujourd'hui — sans carte bancaire, sans engagement. Passez à Erudia+ quand vous êtes prêt.",
      btnPrimary: "Essayer gratuitement",
      btnSecondary: "Démarrer Erudia+ — 4,99€/mois",
      reassure1: "7 jours d'essai gratuits",
  ...
  contact: {
    hero: {
      ...
      subline:
        "Vous parlez directement à Johan — créateur, développeur et designer d'Erudia. Pas un bot, pas un formulaire automatique.",
      emailLabel: "Email",
      studioLabel: "Studio",
      locationLabel: "Localisation",
      locationValue: "Sud de la France 🌞",
      responseNote: "Je réponds en moins de 48h — en français ou en anglais.",
    },
    form: {
      heading: "Écrivez-moi",
  ...
  legal: {
    ...
    mentions: {
      ...
      subtitle: "Informations légales obligatoires relatives au site erudia.app et à l'application app.erudia.app.",
      sections: [
        {
    ...
    privacy: {
      ...
      subtitle: "Erudia s'engage à protéger la vie privée des utilisateurs, et en particulier celle des enfants. Cette politique détaille les données collectées et les droits des utilisateurs.",
      sections: [
        {
    ...
    terms: {
      ...
      subtitle: "En utilisant Erudia, vous acceptez les présentes conditions. Nous vous invitons à les lire attentivement.",
      sections: [
        {
