...
export const fr = {
  ...
  home: {
    ...
    pedago: {
      ...
      level3Desc: "Culture internationale, programme 6e–5e",
      stat1Num: "600+",
    ...
    pricingTeaser: {
      ...
      note: "Annulation à tout moment · Remboursement 7 jour",
    },
    faqMini: {
      ...
      a4: "La version gratuite inclut 3 catégories (Sciences, Histoire, Héros), avec jusqu'à 100 questions par catégorie. Les badges, le mode hors ligne et le suivi parental sont disponibles pour tous. Erudia+ débloque les 18 catégories restantes.",
    },
    cta: {
      title: "Prêt à commencer l'aventure ?",
      subline: "Créez un profil enfant en 10 secondes.",
  ...
  features: {
    ...
    cta: {
      ...
      subline: "Créez un profil en 10 secondes. Gratuit.",
      btnPrimary: "🚀 Créer un profil enfant",
      ...
      items: [
        {
          ...
          desc: "Accès protégé. Pas de compte parent séparé à créer le bouton admin est discret dans l'interface enfant.",
          list: [],
        },
        {
          icon: "📈",
        ...
        },
        {
          ...
          desc: "Local-first : les données vivent dans le navigateur. Synchronisation automatique. Consultez les stats depuis n'importe quel appareil.",
          list: [],
        },
        {
          icon: "🗑️",
    ...
    convictions: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Les questions sont générées. Chaque question est alignée sur les programmes officiels français (CP → 6e) et le curriculum international (Grade 1 → Grade 6). L'enfant révise ce qu'il apprend durant l'année scolaire, avec un angle différent. Le niveau Difficile monte jusqu'au collège pour que l'app grandisse avec lui.",
          insightIcon: "📐",
          insightStrong: "",
          insightText: "20 catégories dispoxl",
        },
        {
          number: "03",
          badge: "Langue",
          ...
          desc: "Beaucoup d'apps éducatives démarrent en anglais et ajoutent d'autres langues en option. On a fait l'inverse : Erudia est nativement bilingue FR/EN. La version anglaise suit une approche FLE (Français Langue Étrangère) alignée sur le CECRL. Chaque session en anglais a une valeur pédagogique, pas juste une traduction.",
          insightIcon: "🌍",
        ...
        },
        {
          ...
          desc: "Un enfant concentré sur ses quiz ne doit pas être interrompu par une bannière ou une vidéo. On refuse de monétiser l'attention des enfants. Erudia est financé uniquement par son abonnement premium",
          insightIcon: "🛡️",
          insightStrong: "Conforme RGPD et COPPA",
          insightText:
            "aucune donnée enfant revendue, aucun tracker tiers. La version gratuite est sans pub.",
        },
        {
          number: "05",
          badge: "Famille",
          ...
          desc: "Nous avons choisi d'intégrer le mode admin directement dans l'app. Le parent accède aux stats, objectifs et rapports PDF en deux clics, depuis le même écran que l'enfant. Superviser sans surveiller.",
          insightIcon: "👨‍👩‍👧",
        ...
        },
        {
          ...
          desc: "Erudia possède un modèle simple : une version gratuite honnête, et un abonnement premium avec tout dedans. Le prix est visible sur la page Tarifs, sans surprise à la caisse.",
          insightIcon: "💳",
      ...
      cards: [
        {
          ...
          desc: "plusieurs styles d'avatars disponibles L'enfant choisit son identité visuelle dès l'onboarding et peut la modifier à tout moment depuis le profil.",
          tag: "Onboarding",
        },
        {
          icon: "🏆",
          title: "130 badges à collectionner",
        ...
        },
        {
          ...
          desc: "Chaque jour, un quiz identique pour tous les joueurs. L'habitude se construit naturellement.",
          tag: "Rétention",
        },

        {
          ...
          desc: "BarChart et PieChart des scores par catégorie, barres de progression CSS, évolution dans le temps. L'enfant voit ses progrès concrets.",
          tag: "Progression",
        },
        {
          icon: "🌍",
